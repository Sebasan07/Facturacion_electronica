...
<!DOCTYPE html>
    ...
    <head>
        ...
        <link href="<%=request.getContextPath()%>/Dashboard/css/inicio.css" rel="stylesheet">
        ...
        <script src="https://kit.fontawesome.com/ba2336a3e9.js" crossorigin="anonymous"></script>
 ...
 <!-- INICIO-->
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                        Empresa</div>
                                                    <div class="h5 mb-0 font-weight-bold text-gray-800">Super suelas</div>
                                                </div>
                                                <div class="col-auto">
                                    ...
                                    <div class="card border-left-primary shadow h-100 py-2">
                                        <div class="card-body">
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                        Identificación (NIT)</div>
                                                    <div class="h5 mb-0 font-weight-bold text-gray-800">254125</div>
                                                </div>
                                                <div class="col-auto">
                                        ...
                                        <div class="card-body">
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    ...
                                                    <div class="h5 mb-0 font-weight-bold text-gray-800">Camila calderon</div>
                                                </div>
                                                <div class="col-auto">
                                        ...
                                        <div class="card-body">
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                        Ciudad</div>
                                                    <div class="h5 mb-0 font-weight-bold text-gray-800">Cucuta</div>
                                                </div>
                                                <div class="col-auto">
                        ...
                        <div class="col-lg-6">
                            <div class="card shadow mb-4">
                               <div class="card-header py-3">
                                ...
                                <div class="card-body">
                                   Configura la información de tu empresa y adapta FactuPyme 
                                   a tu negocio
                                   <a class="ancla" href="<%=request.getContextPath()%>/inicio/empresa/datosFiscalesEmpresa">Empresa</a>
                                   <a class="ancla" href="<%=request.getContextPath()%>/inicio/usuario/ver">Usuarios</a>
                                </div>
                            </div>
                        </div>
        ...
        <!-- Page level plugins -->
        <script src="<%=request.getContextPath()%>/Dashboard/vendor/chart.js/Chart.min.js"></script>

        <!-- Page level custom scripts -->
        <script src="<%=request.getContextPath()%>/Dashboard/js/demo/chart-area-demo.js"></script>
        <script src="<%=request.getContextPath()%>/Dashboard/js/demo/chart-pie-demo.js"></script>
