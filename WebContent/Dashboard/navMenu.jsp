	...
	<li class="nav-item"><a class="nav-link collapsed" href="#"
		...
		<div id="collapseTwo" class="collapse show"
			...
			<div class="bg-white py-2 collapse-inner rounded">
				...
				%>
				<a class="collapse-item" href="#">Agregar producto<br> <span
					style="font-size: 10px;">(Debe crear empresa)</span></a>
				<%
					}
				%>
			</div>
	...
	<li class="nav-item"><a class="nav-link collapsed" href="#"
		...
		<div id="collapseUtilities" class="collapse"
			...
			<div class="bg-white py-2 collapse-inner rounded">
				...
				%>
				<a class="collapse-item" href="#">Agregar cliente<br> <span
					style="font-size: 10px;">(Debe crear empresa)</span></a>
				<%
					}
				%>
		...
		<div id="collapsePages" class="collapse"
			...
			<div class="bg-white py-2 collapse-inner rounded">
				...
				<a class="collapse-item"
					...
					factura</a> <a class="collapse-item">Rangos de numeración</a>
			</div>
		</div></li>
