<!--Inicio de la barra rateral -->
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!--Titulo empresa -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<%=request.getContextPath()%>/inicio">
                <!-- <div class="sidebar-brand-icon rotate-n-15">
                    <i class="fas fa-laugh-wink"></i>
                </div>
                <div class="sidebar-brand-text mx-3">Empresa</div> -->
                <div class="sidebar-brand-text mx-3">Empresa</div>
                <img alt="logo" height="200%" src="<%=request.getContextPath()%>/Dashboard/img/soltec.png">
            </a>
