...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#rol').one("click", function() {
			$('#rol').empty();
			$('#rol').prepend("<option value='3'>Vendedor</option>");
			$('#rol').prepend("<option value='2'>Contador</option> ");
			$('#rol').prepend("<option value='1'>Administrador</option> ");
		});
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<div class="card-body">
							<form
								action="<%=request.getContextPath()%>/inicio/usuario/editar/validar"
								method="post">
								<div class="user-details">
									...
									<div class="input-box">
										<span class="details">Nombre</span> <input type="text"
											name="nombre" value="<%=us.getNombre()%>" required>
									</div>
									<div class="input-box">
										<span class="details">Apellidos</span> <input type="text"
											name="apellido" value="<%=us.getApellido()%>" required>
									</div>
									<div class="input-box">
										<span class="details">Correo</span> <input type="email"
											name="correo" value="<%=us.getCorreo()%>" readonly>
									</div>
									<div class="input-box">
								...
								<div class="buttom2">
									<a href="<%=request.getContextPath()%>/inicio/usuario/ver">Cancelar</a>
								</div>
							</form>
						</div>
					</div>
