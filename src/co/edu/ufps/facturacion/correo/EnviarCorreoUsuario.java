...
public class EnviarCorreoUsuario {
	...
	public boolean enviarCorreo(String nombreArchivo, String rol, File img,String nombreAnimal,Usuario us) {
		System.out.println("dadssada");
		boolean creado=false;
		boolean enviado=false;
		try {
			correo = new Correo("huelleritosfundacion@gmail.com", nombreArchivo, "Huelleritos3259", "", "------------correo--------------",
					"Se adjunta información sobre la solicitud.", "Solicitud " + rol);

			creado=generarPDF.generarPDF(nombreArchivo, rol, img,nombreAnimal,us);
